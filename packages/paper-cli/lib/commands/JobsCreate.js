...
class JobsCreate extends BaseCommand_1.BaseCommand {
    async run() {
        await this.auth();
        const params = await this.params(this.parse(JobsCreate).flags, ["registryPassword", "workspacePassword"], []);
...
JobsCreate.flags = {
    ...
    "nodeAttrs": command_1.flags.integer({
    ...
    "registryPassword": command_1.flags.boolean({
    ...
    "registryUsername": command_1.flags.string({
    ...
    "sharedMemMBytes": command_1.flags.integer({
    ...
    "workspacePassword": command_1.flags.boolean({
    ...
    "workspaceUsername": command_1.flags.string({
