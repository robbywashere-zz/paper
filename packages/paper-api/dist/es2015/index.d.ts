...
export declare type ArtifactsGetResponse = {
    Credentials?: {
        AccessKeyId?: string;
...
export declare type ArtifactsListResponse = Array<{
    file: string;
    size: number;
}>;
...
export declare type ArtifactsDestroyResponse = any;
...
export default class Api {
  ...
  * @param {string} [dest] - Optional; an existing directory to copy the artifacts files to.
    ...
    ArtifactsGet(parameters: {
        ...
        files?: string;
        dest?: string;
    }): Promise<ResponseWithBody<ArtifactsGetResponse>>;
