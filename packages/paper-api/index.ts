...
export default class Api {
  ...
  private pick(list: string[], params?: { [key: string]: any }) {
    if (!params) return;
    return list.reduce((p, n) => ({ ...p, [n]: params[n] }), {});
  }
  ...
  JobsArtifactsGet(parameters: {
    ...
    return this.request<JobsArtifactsGetResponse>({
      ...
      queryParams: this.pick(["jobId", "files", "dest", "json"], parameters)
    });
  }
  ...
  JobsArtifactsList(parameters: {
    ...
    return this.request<JobsArtifactsListResponse>({
      ...
      method: "GET",
      bodyParams: undefined,
      queryParams: this.pick(
        ["jobId", "files", "size", "links", "json"],
        parameters
      )
    });
  }
  ...
  JobsMachineTypes(parameters?: {
    ...
    return this.request<JobsMachineTypesResponse>({
      ...
      bodyParams: undefined,
      queryParams: this.pick(
        ["region", "cluster", "machineType", "isBusy"],
        parameters
      )
    });
  }
...
* @param {string} [userId] - If assigning to an existing user other than yourself, specify the user id (mutually exclusive with email, password, firstName, lastName)
  ...
  NetworksList(parameters?: {
    ...
    return this.request<NetworksListResponse>({
      ...
      bodyParams: undefined,
      queryParams: this.pick(
        ["id", "name", "region", "dtCreated", "network", "netmask", "teamId"],
        parameters
      )
    });
  }
  ...
  UsersList(parameters?: {
    ...
    return this.request<UsersListResponse>({
      ...
      bodyParams: undefined,
      queryParams: this.pick(
        ["id", "email", "firstname", "lastname", "dtCreated", "teamId"],
        parameters
      )
    });
  }
