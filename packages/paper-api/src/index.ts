...
export type JobsArtifactsDestroyResponse = any;
...
export type JobsDestroyResponse = any;
export type JobsStopResponse = any;
...
export type MachinesDestroyResponse = any;
export type MachinesRestartResponse = any;
export type MachinesStartResponse = any;
export type MachinesStopResponse = any;
export type MachinesUpdateResponse = any;
...
export type ScriptsDestroyResponse = any;
...
* @param {string} password - Password for the specified email address
  ...
  LoginUser(parameters: { apiToken?: string; email: string; password: string }) {

  this.checkParams(["email","password"],parameters)

  return this.request<LoginUserResponse>({
...
* @param {string} [dest] - Optional; an existing directory to copy the artifacts files to.
  ...
  JobsArtifactsGet(parameters: { jobId: string; files?: string; dest?: string }) {

  this.checkParams(["jobId"],parameters)

  return this.request<JobsArtifactsGetResponse>({
...
* @param {boolean} [links] - Optional; include https links to artifacts.  Note: links are only valid for 8 hours. '--links' with no value is equivalent to true.
  ...
  JobsArtifactsList(parameters: { jobId: string; files?: string; size?: boolean; links?: boolean }) {

  this.checkParams(["jobId"],parameters)

  return this.request<JobsArtifactsListResponse>({
...
* @param {string} [workspaceUsername] - An optional username for accessing a private git repository.  Note: you must specify this option every time a private git repository is specified for the workspace.
  ...
  JobsCreate(parameters: { cluster?: string; clusterId?: string; codeCommit?: string; command?: string; container: string; dataset?: string; json?: boolean; machineType?: string; name?: string; nodeAttrs?: number; ports?: string; project?: string; projectId?: string; registryPassword?: string; registryUsername?: string; sharedMemMBytes?: number; tail?: boolean; workspace?: string; workspacePassword?: string; workspaceUsername?: string }) {

  this.checkParams(["container"],parameters)

  return this.request<JobsCreateResponse>({
    path: '/jobs/createJob',
    method: 'POST',
...
* @param {boolean} [isBusy] - Optional busy status value to match on
  ...
  JobsMachineTypes(parameters?: { region?: string; cluster?: string; machineType?: string; isBusy?: boolean }) {

  

  return this.request<JobsMachineTypesResponse>({
...
* @param {string} state - Name of the state to wait for
  ...
  JobsWaitfor(parameters: { jobId: string; state: string }) {

  this.checkParams(["jobId","state"],parameters)

  return this.request<JobsWaitforResponse>({
    path: '/jobs/getJob',
    method: 'GET',
    bodyParams: undefined,
...
* @param {string} [dataset] - Optional dataset to match on
  ...
  JobsList(parameters?: { project?: string; projectId?: string; name?: string; machineType?: string; state?: string; container?: string; command?: string; workspace?: string; dataset?: string }) {
...
* @param {number} [limit] - Optional; number of log lines to retrieve on each request; default limit is 2000.
  ...
  JobsLogs(parameters: { jobId: string; tail?: boolean; line?: number; limit?: number }) {

  this.checkParams(["jobId"],parameters)

  return this.request<JobsLogsResponse>({
    path: '/jobs/logs',
    method: 'GET',
    bodyParams: undefined,
...
* @param {string} [files] - Optional; if destroying only certain files, a wildcard pattern to match against, e.g., "myfiles*".  Note: if you include a wildcard you must double-quote the files argument.
  ...
  JobsArtifactsDestroy(parameters: { jobId: string; files?: string }) {

  this.checkParams(["jobId"],parameters)

  return this.request<JobsArtifactsDestroyResponse>({
  ...
  JobsClone(parameters: { jobId: string }) {

  this.checkParams(["jobId"],parameters)

  return this.request<JobsCloneResponse>({
  ...
  JobsDestroy(parameters: { jobId: string }) {

  this.checkParams(["jobId"],parameters)

  return this.request<JobsDestroyResponse>({
  ...
  JobsStop(parameters: { jobId: string }) {

  this.checkParams(["jobId"],parameters)

  return this.request<JobsStopResponse>({
...
* @param {string} [userId] - If assigning to an existing user other than yourself, specify the user id (mutually exclusive with email, password, firstName, lastName)
  ...
  MachinesCreate(parameters: { assignPublicIp?: boolean; billingType: string; dynamicPublicIp?: boolean; email?: string; firstName?: string; lastName?: string; machineName: string; machineType: string; networkId?: string; notificationEmail?: string; password?: string; region: string; scriptId?: string; size: number; teamId?: string; templateId: string; userId?: string }) {

  this.checkParams(["region","machineType","size","billingType","machineName","templateId"],parameters)

  return this.request<MachinesCreateResponse>({
...
* @param {string} machineType - Machine type: either 'GPU+', 'P4000', 'P5000', 'P6000', or 'V100'<p>
  ...
  MachinesAvailability(parameters: { region: string; machineType: string }) {

  this.checkParams(["region","machineType"],parameters)

  return this.request<MachinesAvailabilityResponse>({
...
* @param {string} state - Name of the state to wait for, either 'off', 'serviceready', 'ready'
  ...
  MachinesWaitfor(parameters: { machineId: string; state: string }) {

  this.checkParams(["machineId","state"],parameters)

  return this.request<MachinesWaitforResponse>({
...
* @param {string} [dtLastRun] - Optional script datetime last run value to match on
  ...
  MachinesList(parameters?: { machineId?: string; name?: string; os?: string; ram?: string; cpus?: number; gpu?: string; storageTotal?: string; storageUsed?: string; usageRate?: string; shutdownTimeoutInHours?: number; performAutoSnapshot?: boolean; autoSnapshotFrequency?: string; autoSnapshotSaveCount?: number; agentType?: string; dtCreated?: string; state?: string; updatesPending?: boolean; networkId?: string; privateIpAddress?: string; publicIpAddress?: string; region?: string; userId?: string; teamId?: string; scriptId?: string; dtLastRun?: string }) {
...
* @param {string} billingMonth - Billing period to query in `YYYY-MM` format
  ...
  MachinesUtilization(parameters: { machineId: string; billingMonth: string }) {

  this.checkParams(["machineId","billingMonth"],parameters)

  return this.request<MachinesUtilizationResponse>({
...
* @param {boolean} [releasePublicIp] - releases any assigned public ip address for the machine; defaults to false
  ...
  MachinesDestroy(parameters: { machineId: string; releasePublicIp?: boolean }) {

  this.checkParams(["machineId"],parameters)

  return this.request<MachinesDestroyResponse>({
  ...
  MachinesRestart(parameters: { machineId: string }) {

  this.checkParams(["machineId"],parameters)

  return this.request<MachinesRestartResponse>({
  ...
  MachinesStart(parameters: { machineId: string }) {

  this.checkParams(["machineId"],parameters)

  return this.request<MachinesStartResponse>({
  ...
  MachinesStop(parameters: { machineId: string }) {

  this.checkParams(["machineId"],parameters)

  return this.request<MachinesStopResponse>({
...
* @param {number} [shutdownTimeoutInHours] - Number of hours before machine is shutdown if no one is logged in via the Paperspace client
  ...
  MachinesUpdate(parameters: { machineId: string; autoSnapshotFrequency?: number; autoSnapshotSaveCount?: number; dynamicPublicIp?: boolean; machineName?: string; performAutoSnapshot?: boolean; shutdownTimeoutForces?: boolean; shutdownTimeoutInHours?: number }) {

  this.checkParams(["machineId"],parameters)

  return this.request<MachinesUpdateResponse>({
...
* @param {string} [teamId] - Optional teamId to match on
  ...
  NetworksList(parameters?: { id?: string; name?: string; region?: string; dtCreated?: string; network?: string; netmask?: string; teamId?: string }) {

  

  return this.request<NetworksListResponse>({
...
* @param {string} [scriptText] - A string containing the script text; either scriptFile or scriptText must be provide.
  ...
  ScriptsCreate(parameters: { isEnabled?: boolean; machineId?: string; runOnce?: boolean; scriptDescription?: string; scriptFile?: string; scriptName: string; scriptText?: string }) {

  this.checkParams(["scriptName"],parameters)

  return this.request<ScriptsCreateResponse>({
  ...
  ScriptsShow(parameters: { scriptId: string }) {

  this.checkParams(["scriptId"],parameters)

  return this.request<ScriptsShowResponse>({
  ...
  ScriptsText(parameters: { scriptId: string }) {

  this.checkParams(["scriptId"],parameters)

  return this.request<ScriptsTextResponse>({
...
* @param {boolean} [runOnce] - Optional runOnce value to match on, either true or false
  ...
  ScriptsList(parameters?: { id?: string; ownerType?: string; ownerId?: string; name?: string; description?: string; dtCreated?: string; isEnabled?: boolean; runOnce?: boolean }) {

  

  return this.request<ScriptsListResponse>({
  ...
  ScriptsDestroy(parameters: { scriptId: string }) {

  this.checkParams(["scriptId"],parameters)

  return this.request<ScriptsDestroyResponse>({
...
* @param {string} [region] - Optional region to match on
  ...
  TemplatesList(parameters?: { id?: string; name?: string; label?: string; os?: string; dtCreated?: string; teamId?: string; userId?: string; region?: string }) {
...
* @param {string} [teamId] - Optional teamId to match on
  ...
  UsersList(parameters?: { id?: string; email?: string; firstname?: string; lastname?: string; dtCreated?: string; teamId?: string }) {
