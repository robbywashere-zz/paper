...
var Api = /** @class */ (function () {
    function Api(apiKey) {
        ...
        this.request = function (req) {
            ...
            var R = superagent_1.default(req.method, req.path);
            if (req.bodyParams)
                R = R.send(req.bodyParams);
            if (req.queryParams)
                R = R.query(req.queryParams);
            return R.set("x-api-key", _this.apiKey).set("accept", "json");
        };
    }
    ...
    Api.prototype.JobsArtifactsList = function (parameters) {
        ...
        return this.request({
            ...
            method: "GET",
            bodyParams: undefined,
            queryParams: this.pick(["jobId", "files", "size", "links", "json"], parameters)
        });
    };
    ...
    Api.prototype.JobsLogs = function (parameters) {
        ...
        return this.request({
            ...
            method: "GET",
            bodyParams: undefined,
            queryParams: this.pick(["jobId", "tail", "line", "limit", "json"], parameters)
        });
    };
